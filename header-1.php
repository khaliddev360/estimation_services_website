...
<title>AllState Estimation - Estimation Services</title>
    ...
    <div id='wrap_all'>
        <header id='header' class='all_colors header_color light_bg_color  av_header_top av_logo_left av_main_nav_header av_menu_right av_slim av_header_sticky av_header_shrinking av_header_stretch_disabled av_mobile_menu_tablet av_header_searchicon av_header_unstick_top_disabled av_bottom_nav_disabled  av_header_border_disabled' role="banner" itemscope="itemscope" itemtype="https://schema.org/WPHeader">
            <div id='header_meta' class='container_wrap container_wrap_meta  av_icon_active_right av_extra_header_active av_phone_active_left av_entry_id_170'>
                <div class="container">
                    <div class="row">
                        <div class="col-md-4" style="font-size: 14px; padding-right: 290px;">
                        ...
                        <div class="col-md-4">
                            <div class="permotion-btn"> <a href="../get-estimate.php" class="avia-slideshow-button avia-button avia-color-light avia-multi-slideshow-button avia-slideshow-button-2">Click here to get estimation</a> </div>
                        </div>
                        <div class="col-md-4">
            ...
            <div id='header_main' class='container_wrap container_wrap_logo'>
                <div class='container av-logo-container'>
                    <div class='inner-container'><span class='logo'><a href='../index.php'><img src="../logo/ESTIMATION.png" height="100" width="300" alt='Construction Estimating Services' title=''></a></span>
